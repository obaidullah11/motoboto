"""
Django settings for motoboto project.
...
# service_account_json = os.path.join(BASE_DIR, 'motoboto', 'adminsdk.json')
# try:
...
WSGI_APPLICATION = 'motoboto.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "motoboto Administration",
    "site_header": "motoboto",
    "site_brand": "motoboto",
    "copyright": "motoboto",
